#!/bin/bash
# UVCoatedClubFlyers - Deploy to VPS Script
# Syncs local -> GitHub -> VPS

set -e

VPS_HOST="root@72.60.28.175"
VPS_PATH="/root/websites/uvcoatedclubflyers"
VPS_PASS="Bobby321&Gloria321Watkins?"

echo "=== UVCoatedClubFlyers Deployment ==="
echo ""
...
echo "Site: https://uvcoatedclubflyers.com"
echo "Port: 3003"
