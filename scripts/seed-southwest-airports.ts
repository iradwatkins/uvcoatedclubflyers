// Seed Southwest Cargo airport locations into PostgreSQL
// Adapted from Prisma to raw SQL for uvcoatedclubflyers-v2
...
async function main() {
  ...
  console.log('\n============================================')
  console.log(`✨ Southwest Cargo airports seeded successfully!`)
