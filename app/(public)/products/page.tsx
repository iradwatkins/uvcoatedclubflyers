      ...
      <section className="border-b bg-card">
        <div className="container-custom py-16">
          ...
          <p className="mx-auto max-w-2xl text-center text-lg text-muted-foreground">
            Professional UV-coated flyers and marketing materials with exceptional quality and fast
            turnaround.
          </p>
        </div>
      </section>
                ...
                <Card key={product.id} className="flex flex-col transition-shadow hover:shadow-lg">
                  ...
                  <CardHeader>
                    <div className="mb-2 flex items-start justify-between">
                      ...
                      {product.status === 'active' && <Badge variant="default">Available</Badge>}
                    </div>
                  ...
                  <CardContent className="flex-1">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">Starting from 100 units</p>
                    </div>
                  </CardContent>
