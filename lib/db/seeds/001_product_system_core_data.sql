...
VALUES
(1, '9pt C2S Cardstock', '9pt-c2s-cardstock', 'Standard cardstock with one side coated for vibrant printing', 0.0010, 0.000333333333, 'CARDSTOCK', '9pt', 1.0, 1.0, NULL, NULL, true, 2)
...
INSERT INTO paper_stocks (id, name, slug, description, base_cost_per_sq_in, weight_per_sq_in, type, thickness, sides_multiplier_single, sides_multiplier_double, special_markup, pricing_group_id, is_active, display_order)
VALUES
(2, '16pt C2S Cardstock', '16pt-c2s-cardstock', 'Premium thick cardstock with professional feel', 0.0015, 0.000415, 'CARDSTOCK', '16pt', 1.0, 1.0, NULL, NULL, true, 6)
ON CONFLICT (name) DO UPDATE SET
  base_cost_per_sq_in = EXCLUDED.base_cost_per_sq_in,
  weight_per_sq_in = EXCLUDED.weight_per_sq_in;
...
INSERT INTO paper_stocks (id, name, slug, description, base_cost_per_sq_in, weight_per_sq_in, type, thickness, sides_multiplier_single, sides_multiplier_double, special_markup, pricing_group_id, is_active, display_order)
VALUES
(3, '60 lb Offset', '60lb-offset', 'Economical text weight paper, uncoated and writable', 0.0008, 0.000133333333, 'TEXT', 'Text weight', 1.0, 1.75, NULL, NULL, true, 1)
ON CONFLICT (name) DO UPDATE SET
  base_cost_per_sq_in = EXCLUDED.base_cost_per_sq_in,
  weight_per_sq_in = EXCLUDED.weight_per_sq_in;
...
INSERT INTO paper_stocks (id, name, slug, description, base_cost_per_sq_in, weight_per_sq_in, type, thickness, sides_multiplier_single, sides_multiplier_double, special_markup, pricing_group_id, is_active, display_order)
VALUES
(4, '100 lb Gloss Text', '100lb-gloss-text', 'Heavy text weight with glossy finish', 0.0010, 0.000225, 'TEXT', 'Text weight (heavy)', 1.0, 1.75, NULL, NULL, true, 3)
ON CONFLICT (name) DO UPDATE SET
  base_cost_per_sq_in = EXCLUDED.base_cost_per_sq_in,
  weight_per_sq_in = EXCLUDED.weight_per_sq_in;
...
INSERT INTO paper_stocks (id, name, slug, description, base_cost_per_sq_in, weight_per_sq_in, type, thickness, sides_multiplier_single, sides_multiplier_double, special_markup, pricing_group_id, is_active, display_order)
VALUES
(5, '12pt C2S Cardstock', '12pt-c2s-cardstock', 'Medium thickness cardstock, ideal for postcards', 0.0012, 0.00035, 'CARDSTOCK', '12pt', 1.0, 1.0, 2.0, 1, true, 4)
ON CONFLICT (name) DO UPDATE SET
  base_cost_per_sq_in = EXCLUDED.base_cost_per_sq_in,
  weight_per_sq_in = EXCLUDED.weight_per_sq_in,
...
INSERT INTO paper_stocks (id, name, slug, description, base_cost_per_sq_in, weight_per_sq_in, type, thickness, sides_multiplier_single, sides_multiplier_double, special_markup, pricing_group_id, is_active, display_order)
VALUES
(6, '100 lb Uncoated Cover', '100lb-uncoated-cover', 'Natural uncoated cover stock, writable surface', 0.0013, 0.000383333333, 'COVER', '~14pt', 1.0, 1.0, NULL, NULL, true, 5)
ON CONFLICT (name) DO UPDATE SET
  base_cost_per_sq_in = EXCLUDED.base_cost_per_sq_in,
  weight_per_sq_in = EXCLUDED.weight_per_sq_in;
...
INSERT INTO paper_stocks (id, name, slug, description, base_cost_per_sq_in, weight_per_sq_in, type, thickness, sides_multiplier_single, sides_multiplier_double, special_markup, pricing_group_id, is_active, display_order)
VALUES
(7, '14pt C2S Cardstock', '14pt-c2s-cardstock', 'Premium cardstock with excellent rigidity', 0.0013, 0.000415, 'CARDSTOCK', '14pt', 1.0, 1.0, 2.0, 2, true, 7)
ON CONFLICT (name) DO UPDATE SET
  base_cost_per_sq_in = EXCLUDED.base_cost_per_sq_in,
  weight_per_sq_in = EXCLUDED.weight_per_sq_in,
  special_markup = EXCLUDED.special_markup,
